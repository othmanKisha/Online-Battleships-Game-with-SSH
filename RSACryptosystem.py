from ModArithmetic import repeated_squaring, multiplicative_inverse
...
class Cryptosystem (object):
    ...
    def __init__(self, p, q, e):
        ...
        self.q = q
        self.e = e
        self.d = multiplicative_inverse(self.e, (self.p - 1) * (self.q - 1))
    ...
    def encryption(self, plaintext, e, N):
        ...
        ciphertext = repeated_squaring(div=plaintext, modulus=N, power=e)
    ...
    def digital_sign(self, plaintext):
        digital_signature = repeated_squaring(
    ...
    def verify_signature(self, N, e, S, ip, H):
        S = b64decode(S)
        verify = repeated_squaring(div=S, modulus=N, power=e)
